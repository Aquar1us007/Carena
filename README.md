# Carena
Carena is a super simple, type-safe memory pool allocator written in C. It uses macros to provide type-safe allocations and includes a benchmark file for testing.
